...
const projects = [
  {
    ...
    linkLive:
      '<a href="https://fpsapc.github.io/awesome-book-withES6/" target="blank">See Live</a>',
    linkSource:
      '<a href="https://github.com/fpsapc/awesome-book-withES6" target="blank">See Source</a>',
  },
  {
    id: "bg-pro2",
    name: "Budget App",
    description:
      "The Ruby on Rails capstone project is about building a mobile web application where someone can manage his budget: He will provide list of transactions associated with a category.",
    featuredImage: "./img/budget.JPG",
    technologies: ["Ruby", "Ruby on Rails", "CSS"],
    seeProject: "See Project",
    linkLive:
      '<a href="https://budget-app-g33j.onrender.com/" target="blank">See Live</a>',
    linkSource:
      '<a href="https://github.com/fpsapc/budget_app" target="blank">See Source</a>',
  },
  {
    id: "bg-pro3",
    ...
    seeProject: "See Project",
    linkLive:
      '<a href="https://crypto-currencies-gb1a.onrender.com/" target="blank">See Live</a>',
    linkSource:
      '<a href="https://github.com/fpsapc/reactcapstoneproject" target="blank">See Source</a>',
  },
  {
    id: "bg-pro4",
    ...
    seeProject: "See Project",
    linkLive:
      '<a href="https://react-redux-group-project.onrender.com/" target="blank">See Live</a>',
    linkSource:
      '<a href="https://github.com/fpsapc/reactreduxgroupproject" target="blank">See Source</a>',
  },
  {
    id: "bg-pro5",
    name: "To Do List",
    description:
      "You can add your daily tasks list here and tick every task acording to its completion. You can also remove and edit tasks. You can also clear all completed tasks after selecting them from the list.",
    featuredImage: "./img/to_do_list.JPG",
    technologies: ["html", "CSS", "JavaScript"],
    seeProject: "See Project",
    linkLive:
      '<a href="https://fpsapc.github.io/To_Do_List/" target="blank">See Live</a>',
    linkSource:
      '<a href="https://github.com/fpsapc/To_Do_List" target="blank">See Source</a>',
  },
  {
    id: "bg-pro6",
    ...
    seeProject: "See Project",
    linkLive:
      '<a href="https://fpsapc-movies-showcase.netlify.app/" target="blank">See Live</a>',
    linkSource:
      '<a href="https://github.com/fpsapc/movies-showcase" target="blank">See Source</a>',
  },
];
...
const allProjects = [
  {
    ...
    description:
      "This project belongs to inform farmers about a meeting and also introduced some aspect of company.",
    featuredImage: "./img/applechemicals.JPG",
    technologies: ["html", "CSS", "JavaScript"],
    seeProject: "See Project",
    linkLive:
      '<a href="https://fpsapc.github.io/AppleChemicals/" target="blank">See Live</a>',
    linkSource:
      '<a href="https://github.com/fpsapc/AppleChemicals" target="blank">See Source</a>',
  },
  {
    id: "bg-pro1",
    name: "Awesome Books",
...
const validate = (email) => {
  ...
  if (checkedEmail === true) {
    ...
    throughError.innerHTML =
      "Please check your email address. email field always be in lower case.";
  }
};
const form = document.getElementById("getintouch-form");
